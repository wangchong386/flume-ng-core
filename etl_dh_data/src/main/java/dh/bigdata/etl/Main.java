...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sparkConf.set("spark.streaming.backpressure.enabled", confUtil.getProperty(Contant.BACKPRESSURE_ENABLED));
        ...
        */
        ...
        topic = "tmp_ods_log_subject_expo";
        ...
        * 4. 将偏移提交到zookeeper
        */
        topic = "flume_ods_log_app";
        JavaInputDStream<MessageAndMetadata<String, byte[]>> odsLogAppKafkaRdd = KafkaDirecStreamFactory.get(jssc,topic);
        JavaDStream<DHEvent> odsLogAppEventRdd = odsLogAppKafkaRdd.map(new Message2LogAppDHEvent());
        ...
        */
        ...
        topic = "tmp_ods_log_app_events_ios";
